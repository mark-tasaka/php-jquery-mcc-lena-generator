...
<html>
<head>
<title>Launch Page: Lena Character Generator</title>
...
<body>
	...
	<section>
        ...
        <br/>
            ...
            <br/>    
			<form action="" id ="lenaForm"  target="_blank" method="post">
		...
		<div class="content8">
			  ...
			  <select id="level" class="dropdownmenu2Iconic">
				<option value="01" selected>Lena, Level 1</option>
				<option value="02">Lena, Level 2</option>
				<option value="03">Lena, Level 3</option>
				<option value="04">Lena, Level 4</option>
				<option value="05">Lena, Level 5</option>
				<option value="06">Lena, Level 6</option>
				<option value="07">Lena, Level 7</option>
				<option value="08">Lena, Level 8</option>
				<option value="09">Lena, Level 9</option>
				<option value="10">Lena, Level 10</option>
			  </select>
        ...
        {
            $("#lenaForm").attr('action', "lena/lena"+ $("#level").val() +  ".php");
        });
