...
<html>
<head>
<title>Iconic NPC Lena Character Generator</title>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="css/mcc_lena.css">
	<link rel="stylesheet" type="text/css" href="css/mcc_lena_post.css">
...
<!-- JQuery -->
  ...
  <script>
	...
	/*
	 Character() - Lena Character Constructor
	*/
	function Character() {
    ...
    let sentinel = getLena();
     ...
     /*getLena() return the statistics for the sentinel per level*/  
    function getLena() {
	let sentinel = [
	...
	return sentinel[8]; 
       ...
       let imgData = "images/lena_character_sheet.png";
